          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div class="qr-code-area">
                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}assets/front/assets/img/resource/qr-code.JPG" alt="">
                ...
                <div class="row header-inner">
                    <div class="col-lg-3 col-md-4 col-sm-4 logo-area">
                        <div class="header-left">
                            <div class="brand-logo"> <a href="{{route('front.home')}}"> <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}assets/front/assets/img/logo.png" alt="logo" class="main-logo"> <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}assets/front/assets/img/logo.png" alt="logo" class="sticky-logo"> </a> </div>
                        </div>
                    </div>
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><a href="#">Services</a></li>
                                    ...
                                    <li><a href="{{route('mylogin')}}" class="user-login"> <i class="far fa-user-circle"></i> Agent Login </a> </li>
                                    <li> <a class="template-btn secondary-bg paynow-btn" href="{{route('mylogin')}}">Apply Now</a> </li>
                                   {{--  <li><button type="button" class="template-btn secondary-bg paynow-btn new-btn" data-toggle="modal" data-target="#Qr_code-model">Pay Now <i class="fas fa-arrow-right"></i></button></li>
 --}}
                                </ul>
        ...
        <div class="mobile-slide-panel">
            ...
            <div class="panel-inner">
                <div class="mobile-logo"> <a href="{{route('front.home')}}"> <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}assets/front/assets/img/logo.png" alt="Common Servicecenters"> </a> </div>
                <nav class="mobile-menu">
                    <ul>
                        <li> <a href="{{route('front.home')}}">Home</a> </li>
                        <li> <a href="{{route('front.about')}}">About Us</a></li>
                        <li> <a href="{{route('front.service')}}">Services</a>
                            <!-- <ul class="sub-menu">
              <li><a href="#">Services</a></li>
              <li><a href="#">Services</a></li>
              <li><a href="#">Services</a></li>
              ...
              <li><a href="#">Services</a></li>
                        ...
                        <li><a href="{{route('mylogin')}}" class="user-login"> <i class="far fa-user-circle"></i> Agent Login </a> </li>
                        <li> <a class="template-btn secondary-bg paynow-btn" href="{{route('mylogin')}}">Apply Now</a> </li>
                        {{-- <li> <button type="button" class="template-btn secondary-bg paynow-btn mobile-new-btn" data-toggle="modal" data-target="#Qr_code-model">Pay Now <i class="fas fa-arrow-right"></i></button></li> --}}
                    </ul>
