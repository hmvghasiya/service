								...
								<div class="card text-center border border-danger box">
									<div class="card-body">
                                        <img src="<?php echo e(asset('assets/images/services/train booking.png')); ?>" style="width:80px; height:80px">
                                            <h6 class="font-w600 fs-16 mb-1"><a href=<?php echo e(route('comingsoon')); ?>" class="text-black">Train</a></h6>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/home.blade.php ENDPATH**/ ?>