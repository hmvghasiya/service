<ul class="icons-list">
                                <li class="dropdown dropup">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
	                                        ...
	                                        <li><a href="<?php echo e(route('itr_reg.view',$data->id)); ?>" > View</a></li>

                                    </ul>
                                </li>
                            </ul><?php /**PATH E:\laragon\www\open_aisa\resources\views/itr_reg/partial/user_action.blade.php ENDPATH**/ ?>