<ul class="icons-list">
                                <li class="dropdown dropup">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
	                                        ...
	                                        <li><a href="<?php echo e(route('e_sharm.view',$data->id)); ?>" > View</a></li>

                                    </ul>
                                </li>
                            </ul><?php /**PATH E:\laragon\www\open_aisa\resources\views/e_sharm/partial/user_action.blade.php ENDPATH**/ ?>