...
.margin-title{
 ...
 <div class="content">
        <div class="row d-flex ">
              ...
              <a href="<?php echo e(route('ration_card.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('ration_card.user_index')); ?>" class="text-black">Ration Card</a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              </a>
              <a href="<?php echo e(route('e_sharm.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('e_sharm.user_index')); ?>" class="text-black">E-Sharm</a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              </a>
              <a href="<?php echo e(route('prepaidcard_load.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('prepaidcard_load.user_index')); ?>" class="text-black">Prepaid Card Load</a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('loan.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('loan.user_index')); ?>" class="text-black">Loan Registration</a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('digital_signature.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('digital_signature.user_index')); ?>" class="text-black">Digital Signature</a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('gst_reg.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('gst_reg.user_index')); ?>" class="text-black">Gst Registration </a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('itr_reg.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('itr_reg.user_index')); ?>" class="text-black">Itr Registration </a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('prepaidcard_kyc.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('prepaidcard_kyc.user_index')); ?>" class="text-black">Prepaid Kyc  </a>
                        </h6>                      
                    </div>
                  </div>
                </div>
              ...
              <a href="<?php echo e(route('nsdl_pancard.user_index')); ?>">
                <div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4 col-sm-6">
                  <div class="card text-center border border-danger box">
                    <div class="card-body">
                      <img src="<?php echo e(asset('assets/images/services/Electricity Bill.png')); ?>" style="width:80px; height:80px">
                        <h6 class="font-w600 fs-16 mb-1">
                          <a href="<?php echo e(route('nsdl_pancard.user_index')); ?>" class="text-black">Nsdl Pancard  </a>
                        </h6>                      
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\open_aisa\resources\views/home.blade.php ENDPATH**/ ?>