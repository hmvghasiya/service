<?php $__env->startSection('title', 'Itr Registration'); ?>
<?php $__env->startSection('pagetitle', 'Itr Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('itr_reg.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '.loan_type', function(event) {
            ...
            // alert(loan_id);
            $.ajax({
                url: '<?php echo e(route('itr_reg.loan_data')); ?>',
                type: 'GET',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/itr_reg/addedit.blade.php ENDPATH**/ ?>