    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel panel-default">
                ...
                <form id="serachForm" action="<?php echo e(route('dmt1pay')); ?>" method="post">
...
<div id="beneficiaryModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt1pay')); ?>" method="post" id="beneficiaryForm">
...
<div id="transferModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt1pay')); ?>" method="post" id="transferForm">
                <?php echo e(csrf_field()); ?>
...
<div id="registrationModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt1pay')); ?>" method="post" id="registrationForm">
                <?php echo e(csrf_field()); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/service/dmt1.blade.php ENDPATH**/ ?>