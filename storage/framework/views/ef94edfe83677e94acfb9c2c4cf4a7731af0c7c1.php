...
<?php $__env->startSection('title', "Recharge Statement"); ?>
<?php $__env->startSection('pagetitle',  "Recharge Statement"); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "<?php echo e(url('statement/fetch')); ?>/rechargestatement/<?php echo e($id); ?>";
        var onDraw = function() {
        };
        var options = [
            { "data" : "name",
            ...
            { "data" : "status",
                render:function(data, type, full, meta){
                    ...
                    if(full.status == "success" || full.status == "pending"){
                        <?php if(Myhelper::can('recharge_status')): ?>
                        ...
                        <?php if(Myhelper::can('recharge_statement_edit')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/statement/recharge.blade.php ENDPATH**/ ?>