                ...
                <div class="col-sm-4">
                    <div class="panel border-left-lg border-left-success invoice-grid timeline-content">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h6 class="text-semibold no-margin-top"><?php echo e($bank->name); ?></h6>
                                    <ul class="list list-unstyled">
                                        <li>IFSC : <span class="text-semibold"><?php echo e($bank->ifsc); ?></span></li>
                                    </ul>
                                </div>

                                <div class="col-sm-6">
                                    <h6 class="text-semibold text-right no-margin-top"><?php echo e($bank->account); ?></h6>
                                    <ul class="list list-unstyled text-right">
                                        <li>Branch : <span class="text-semibold"><?php echo e($bank->branch); ?></span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/fund/request.blade.php ENDPATH**/ ?>