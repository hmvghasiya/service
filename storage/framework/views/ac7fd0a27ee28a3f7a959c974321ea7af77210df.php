...
<!-- Added by HTTrack -->
<!-- Mirrored from nikatby.in/login-new/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Jun 2021 08:41:48 GMT -->
...
<!-- Font Awesome -->
 ...
 <script type="text/javascript">
   ...
   <link rel="shortcut icon" href="<?php echo e(asset('')); ?>assets/nikatby.in/login-new/Portal/images/favicon.png"">
</head>
                    ...
                    <div class="row align-items-center">
                        <div id="divLogin" class="col-md-5">
                            ...
                            <div id="login1">
                                ...
                                <div class="rw">
                                    <p>User ID</p>
                                    <input type="text" class="txt1 form-control" placeholder="login id / mobile" name="mobile"  pattern="[0-9]*" maxlength="11" minlength="10" required>
                                ...
                                <div class="rw">
                                    <p>Password</p>
                                    <input type="password" class="form-control txt1" placeholder="Password" name="password" placeholder="Password" required>
 ...
 $( document ).ready(function() {
            ...
            $('#passwordView').click(function() {
                ...
                if(passwordType == "password"){
                    ...
                    $(this).find('i').removeClass('icon-eye2').addClass('icon-eye-blocked2');
                }else{
                    $(this).closest('form').find('[name="password"]').attr('type', "password");
                    $(this).find('i').addClass('icon-eye2').removeClass('icon-eye-blocked2');
                }
            });
                    ...
                    form.ajaxSubmit({
                        ...
                        success:function(data){
                            ...
                            if(data.status == "Login"){
                                ...
                                $('div.formdata').append(`<div class="form-group wrap-input100 validate-input m-b-20" data-validate="Type Otp">
                                    <input class="form-control input100" type="password" name="otp" placeholder="Otp" required>
                                    <span class="focus-input100"></span>
                                </div><a href="javascript:void(0)" id="otpResend" class="text-primary pull-right">Resend Otp</a> `);
...
<!-- Mirrored from nikatby.in/login-new/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Jun 2021 08:42:06 GMT -->
</html>
<?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/welcome.blade.php ENDPATH**/ ?>