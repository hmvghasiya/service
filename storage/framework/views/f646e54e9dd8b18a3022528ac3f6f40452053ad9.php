<?php $__env->startSection('title', "Xpress Money Transfer"); ?>
<?php $__env->startSection('pagetitle', "Xpress Money Transfer"); ?>
<?php
    $table = "yes";
?>
        ...
        <div class="col-sm-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Xpress Money Transfer</h4>
                </div>
                <form id="serachForm" action="<?php echo e(route('dmt2pay')); ?>" method="post">
...
<div id="beneficiaryModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt2pay')); ?>" method="post" id="beneficiaryForm">
...
<div id="transferModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt2pay')); ?>" method="post" id="transferForm">
                <?php echo e(csrf_field()); ?>
...
<div id="registrationModal" class="modal fade" role="dialog" data-backdrop="false" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dmt2pay')); ?>" method="post" id="registrationForm">
                <?php echo e(csrf_field()); ?>
    ...
    function setBeneData(data) {
        if(data.message.Data.length > 0){
            ...
            $.each(data.message.Data , function(index, beneficiary) {
                ...
                out +=`<button class="btn bg-slate btn-xs legitRipple" onclick="sendMoney('`+data.message.custmobile+`','`+data.message.custfirstname+`','`+beneficiary.bankid+`', '`+beneficiary.beneaccno+`', '`+beneficiary.ifsc+`', '`+beneficiary.benename+`', '`+beneficiary.benemobile+`', '`+beneficiary.bankname+`')"><i class="fa fa-paper-plane"></i> Send</button>`;
                }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/loginsalairechar/public_html/resources/views/service/dmt2.blade.php ENDPATH**/ ?>