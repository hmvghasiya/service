...
<?php $__env->startPush('script'); ?>
    ...
    $(document).ready(function () {
        ...
        var options = [
            ...
            { "data" : "action",
                render:function(data, type, full, meta){
                    return `<button type="button" class="btn bg-slate btn-raised legitRipple btn-xs" onclick="editSetup(`+full.id+`, \``+full.name+`\`, \``+full.recharge1+`\`, \``+full.recharge2+`\`, \``+full.type+`\`, \``+full.api_id+`\`)"> Edit</button>`;
                }
            },
        ];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/setup/operator.blade.php ENDPATH**/ ?>