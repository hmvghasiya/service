<?php $__env->startSection('title', 'E Sharm Registration'); ?>
<?php $__env->startSection('pagetitle', 'E Sharm Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('e_sharm.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">E Sharm Registration List</h4>
                        ...
                        <div class="heading-elements">
                            <a href="<?php echo e(route('e_sharm.create')); ?>"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '.loan_type', function(event) {
            ...
            // alert(loan_id);
            $.ajax({
                url: '<?php echo e(route('e_sharm.loan_data')); ?>',
                type: 'GET',
...
<script type="text/javascript">
    ...
    var oTable = $('#datatable').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('e_sharm.user_any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click",".change_rat_status",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('e_sharm.single_status_change')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/e_sharm/addedit.blade.php ENDPATH**/ ?>