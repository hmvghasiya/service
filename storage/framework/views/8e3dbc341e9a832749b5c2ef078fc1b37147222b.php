<?php $__env->startSection('title', 'NSDL PanCard Form Registration'); ?>
<?php $__env->startSection('pagetitle', 'NSDL PanCard Form Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('nsdl_pancard.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel-body p-b-0">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="application_type" class="form-control select application_type" id="application_type" >
                                    <option value="">Select One</option>
                                    <?php $__currentLoopData = getApplicationTypeDropdown(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '#application_type', function(event) {
            ...
            var application_id=$('#application_type').find(":selected").val();
            $.ajax({
                url: '<?php echo e(route('nsdl_pancard.nsdl_data')); ?>',
                type: 'Get',
                data: {application_id: application_id},
                success:function(response) {
                    $('.res_all').removeAttr('style');
                    $('.nsdl_res').html(response);
                }
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/nsdl_pancard/addedit.blade.php ENDPATH**/ ?>