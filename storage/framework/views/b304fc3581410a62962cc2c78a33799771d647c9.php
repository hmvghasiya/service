<?php $__env->startSection('title', 'Prepaid Card Load Registration'); ?>
<?php $__env->startSection('pagetitle', 'Prepaid Card Load Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('prepaidcard_load.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Prepaid Card Load Registration List</h4>
                        ...
                        <div class="heading-elements">
                            <a href="<?php echo e(route('prepaidcard_load.create')); ?>"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //     // alert(loan_id);
        //     $.ajax({
        //         url: '<?php echo e(route('prepaidcard_load.loan_data')); ?>',
        //         type: 'GET',
...
<script type="text/javascript">
    ...
    var oTable = $('#datatable').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('prepaidcard_load.user_any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click",".change_rat_status",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('prepaidcard_load.single_status_change')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/prepaidcard_load/addedit.blade.php ENDPATH**/ ?>