                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <?php if(Myhelper::hasNotRole('admin')): ?>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <?php if(Myhelper::can('dmt1_service')): ?>
                                        <li><a href="<?php echo e(route('dmt1')); ?>">M-Money Transfer</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <li>
                            ...
                            <li><a href="<?php echo e(route('insurance')); ?>"><i class="fa fa-credit-card"></i> Insurance</a></li>
...
</div><!-- /.modal --><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>