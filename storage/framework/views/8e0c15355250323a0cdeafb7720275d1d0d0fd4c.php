<?php $__env->startSection('title', 'Gst Registration'); ?>
<?php $__env->startSection('pagetitle', 'Gst Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('gst_reg.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
...
<div class="content">
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Gst Registration List</h4>

                    
                        <div class="heading-elements">
                            <a href="<?php echo e(route('gst_reg.create')); ?>"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '.loan_type', function(event) {
            ...
            // alert(loan_id);
            $.ajax({
                url: '<?php echo e(route('gst_reg.loan_data')); ?>',
                type: 'GET',
...
<script type="text/javascript">
    ...
    var oTable = $('#datatable').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('gst_reg.user_any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click",".change_rat_status",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('gst_reg.single_status_change')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/gst_reg/addedit.blade.php ENDPATH**/ ?>