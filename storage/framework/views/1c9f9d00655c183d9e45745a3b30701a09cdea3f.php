<?php $__env->startSection('title', 'Digital Signature Registration'); ?>
<?php $__env->startSection('pagetitle', 'Digital Signature Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('digital_signature.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Digital Signature Registration List</h4>
                        ...
                        <div class="heading-elements">
                            <a href="<?php echo e(route('digital_signature.create')); ?>"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '.loan_type', function(event) {
            ...
            // alert(loan_id);
            $.ajax({
                url: '<?php echo e(route('digital_signature.loan_data')); ?>',
                type: 'GET',
...
<script type="text/javascript">
    ...
    var oTable = $('#datatable').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('digital_signature.user_any_data'); ?>',
            data: function (d) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/digital_signature/addedit.blade.php ENDPATH**/ ?>