                ...
                <form id="rechargeForm" action="<?php echo e(route('rechargepay')); ?>" method="post">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="number" class="form-control" placeholder="Enter <?php echo e($type); ?> number" onchange="getOperator()" required="">
                        </div>
...
<?php $__env->startPush('script'); ?>
    ...
    function getOperator() {
        ...
        if(number != ''){
            $.ajax({
                url: '<?php echo e(route("getproviderInfo")); ?>',
                type: 'post',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data : {"type" : "<?php echo e($type); ?>", 'number' : number},
                beforeSend : function(){
                    swal({
                        title: 'Wait!',
                        text: 'Please wait, we are fetching commission details',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xpresspay/public_html/resources/views/service/recharge.blade.php ENDPATH**/ ?>