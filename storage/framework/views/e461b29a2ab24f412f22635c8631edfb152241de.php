<?php $__env->startSection('title', 'Loan Registration'); ?>
<?php $__env->startSection('pagetitle', 'Loan Registration'); ?>
<?php $__env->startSection('content'); ?>
<div class="content">
    <form class="FromSubmit" action="<?php echo e(route('loan.store')); ?>" id="rationform" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="state" class="form-control select" >
                                    ...
                                    <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value->state); ?>"><?php echo e($value->state); ?></option>
                        ...
                        <div class="row">
                             <div class="form-group col-md-12">
                                ...
                                <select name="loan_type" class="form-control select loan_type" >
                                    ...
                                    <?php $__currentLoopData = getLoanTypeDropdown(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="content">
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Loan Registration List</h4>

                    
                        <div class="heading-elements">
                            <a href="<?php echo e(route('loan.create')); ?>"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '.loan_type', function(event) {
            ...
            // alert(loan_id);
            $.ajax({
                url: '<?php echo e(route('loan.loan_data')); ?>',
                type: 'GET',
...
<script type="text/javascript">
    ...
    var oTable = $('#datatable').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('loan.user_any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click",".change_rat_status",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('loan.single_status_change')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\open_aisa\resources\views/loan/addedit.blade.php ENDPATH**/ ?>