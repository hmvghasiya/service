                ...
                render:function(data, type, full, meta){
                    ...
                    <?php endif; ?>
                     ...
                     <?php if(Myhelper::can(['member_account_statement_view'])): ?>
                        menu2 += `<li><a href="<?php echo e(url('statement/xpressmoney/')); ?>/`+full.id+`" target="_blank"><i class="icon-paragraph-justify3"></i> Xpress Dmt Report</a></li>`;
                    <?php endif; ?>
                    ...
                    <?php if(Myhelper::can(['member_account_statement_view'])): ?>
                        menu2 += `<li><a href="<?php echo e(url('statement/account/')); ?>/`+full.id+`" target="_blank"><i class="icon-paragraph-justify3"></i> Wallet Report</a></li>`;
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/loginsalairechar/public_html/resources/views/member/index.blade.php ENDPATH**/ ?>