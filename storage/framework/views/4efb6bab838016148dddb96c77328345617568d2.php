        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-slate">
                    ...
                    <h4 class="modal-title"><?php echo e($key); ?> Commission</h4>
                </div>
            ...
            { "data" : "action",
                render:function(data, type, full, meta){
                    var menu = ``;
                        ...
                        <?php $__currentLoopData = $commission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        menu += `<li><a href="javascript:void(0)" onclick="commission(`+full.id+`, '<?php echo e($key); ?>','<?php echo e($key); ?>Modal')"><i class="fa fa-inr"></i> <?php echo e($key); ?> Commission</a></li>`;
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/finoviti/public_html/Reseller/nikatby.co.in/Reseller/login.kishalaypay.com/resources/views/resource/scheme.blade.php ENDPATH**/ ?>