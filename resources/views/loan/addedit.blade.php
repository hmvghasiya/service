@extends('layouts.app')
@section('title', 'Loan Registration')
@section('pagetitle', 'Loan Registration')
@section('content')
<div class="content">
    <form class="FromSubmit" action="{{ route('loan.store') }}" id="rationform" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-heading">
                    ...
                    {{-- @if ($role || sizeOf($roles) > 0) --}}
                        <div class="heading-elements">
                            <a href="{{route('loan.create')}}"><button type="button" class="btn btn-sm bg-slate btn-raised heading-btn legitRipple">
    ...
    $(document).on("click",".change_rat_status",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"{{route('loan.single_status_change')}}",
