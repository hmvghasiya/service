...
<link href="{{asset('')}}assets/nikatby.in/login-new/Portal/logincss/bootstrap.min.css" rel="stylesheet" type="text/css" />
<!-- Font Awesome -->
    <link  href="{{asset('')}}assets/nikatby.in/cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css" />
    <!-- Ionicons -->
    <link  href="{{asset('')}}assets/nikatby.in/cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.html" />

    <!-- <link href="Portal/logincss/font-awesome.min.css" rel="stylesheet" type="text/css" /> -->
    <link href="{{asset('')}}assets/nikatby.in/login-new/Portal/logincss/custom2.css" rel="stylesheet" type="text/css" />
    <style>
 ...
 <script type="text/javascript">
    ...
    <link rel="stylesheet" href="{{asset('')}}assets/cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    
</head>
<body id="mybody" style="background-image: url({{asset('')}}assets/nikatby.in/login-new/Portal/images/1.jpg);">
...
<script src="{{asset('')}}assets/nikatby.in/login-new/WebResource31853185.html?d=pXWhQCeIFASIVPlgkOMeu2sYMrMTgaOukhCiER8Nnursodvfw0jQ1WCNZ1OP1ZLx0nywuGopQc1-ZHV_mDscv-XfZpw1&amp;t=636577232940000000" type="text/javascript"></script>


<script src="{{asset('')}}assets/nikatby.in/login-new/WebResource165c165c.html?d=ZyCb6q1afXkb8a5tR9EH3kC7Ce6MzGj7sWKnm5ArWHBi_7ariVkhXg19DMZn45i5Q2575d208gzZdzBwqkfb61VIx4E1&amp;t=636577232940000000" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="logo" style="margin:2% 0px 2%;">
                    ...
                    <a href="#"><img id="imgCompanyLogo" class="img-fluid" src="{{asset('public/logos')}}/{{$mydata['company']->logo}}" style="border-style:None;border-width:0px;width:150px" /></a>
                    @endif
                    </div>
             ...
             <div class="col-xl-2 col-lg-6 col-md-6">
               {{--  <div class="easy_secure gry_bx">
                    <div class="center_es">
                        ...
                        <div class="m_trns_img text-center"><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/cover-customer-services.svg" class="img-fluid"  alt="img" style="max-height:200px"></div>
                    </div>
                </div> --}}
            </div>
                ...
                <div class="login_f gradient_bg">
                    <div class="row align-items-center">
                        <div id="divLogin" class="col-md-5">
                            ...
                            <div id="login1">
                                ...
                                <div class="rw">
                                    ...
                                    <span id="rfvLoginID" style="color:Red;display:none;"><img src="{{asset('')}}assets/nikatby.in/login-new/images/warning.html"/>
                                ...
                                <div class="rw mt-3">
                                    ...
                                    <span id="rfvPassword" style="color:Red;display:none;"><img src="{{asset('')}}assets/nikatby.in/login-new/images/warning.html"/>
                                    </span>
                                </div>
                                <div class="formdata">
                                
                               </div>
                                <div class="rw d-flex align-items-center justify-content-between mt-3">
                        ...
                        <div class="col-md-7 text-center">
                            <div class="lock">
                                <img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/lock.png" class="img-fluid" alt="img">
                            </div>
                        </div>
             ...
             {{-- <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="contact_bx gry_bx">
                    <div class="center_es">
                        <h3>Contact Us</h3>
                        <ul>
                            <li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/company.png" alt="img"></i>  {{$mydata['address']}}<br></li>
                            <li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/address.png" alt="img"></i>  {{$mydata['city']}}</li>
                            <li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/email.png"  alt="img"></i> {{$mydata['supportemail']}}</li>
                            <li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/phone.png"  alt="img"></i>{{$mydata['supportnumber']}}</li>
                <!--<li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/whats%20app.png"  alt="img"></i>{{$mydata['supportnumber']}}</li>                   -->
                            <li><i><img src="{{asset('')}}assets/nikatby.in/login-new/Portal/images/web-site.png"  alt="img"></i> @if(isset($mydata['company'])) {{$mydata['company']->website}} @endif </li>
                        </ul>
                    </div>
                </div>
            </div> --}}
    ...
    <script src="{{asset('')}}assets/nikatby.in/ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.html"></script>
    <script>        window.jQuery || document.write('<script src="{{asset('')}}assets/nikatby.in/login-new/js/libs/jquery-1.7.min.html">\x3C/script>')</script>
    <script src="{{asset('')}}assets/nikatby.in/login-new/Portal/loginjs/bootstrap.js"></script>
