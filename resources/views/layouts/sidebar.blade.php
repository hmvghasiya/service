            ...
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    @if (Myhelper::hasNotRole('admin'))
                        @if (Myhelper::can(['recharge_service', 'billpayment_service']))
                        <li>
                            ...
                            <ul>
                                @if (Myhelper::can('recharge_service'))
                                    ...
                                    <li><a href="{{route('bbps' , ['type' => 'fasttag'])}}">FASTag</a></li>
                                    <li><a href="{{route('bbps' , ['type' => 'cable'])}}">Cable TV</a></li>
                                @endif
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                @if (Myhelper::can('billpayment_service'))
                                    ...
                                    <li><a href="{{route('bill' , ['type' => 'gasutility'])}}">Piped Gas</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'landline'])}}">Landline</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'postpaid'])}}">Postpaid</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'schoolfees'])}}">Education Fees</a></li>
                                @endif
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                @if (Myhelper::can('billpayment_service'))
                                    <li><a href="{{route('bill' , ['type' => 'loanrepay'])}}">Loan Repayment</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'insurance'])}}">LIC/Insurance</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'muncipal'])}}">Municipal Tax</a></li>
                                    <li><a href="{{route('bill' , ['type' => 'housing'])}}">Housing Tax</a></li>
                                @endif
                            </ul>
                        </li>
                        @endif
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    @if (Myhelper::can('dmt2_service'))
                                        <li><a href="{{route('dmt2')}}">Xpress-Money Transfer</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                        <li>
                            ...
                            <ul>
                                    <li><a href="{{route('travel' , ['type' => 'flight'])}}">Flight Booking</a></li>
                                    <li><a href="{{route('travel' , ['type' => 'bus'])}}">Bus Booking</a></li>
                                    <li><a href="{{route('travel' , ['type' => 'hotel'])}}">Hotel Booking</a></li>
                                    <li><a href="https://www.agent.irctc.co.in/" target="_blank">IRCTC Booking</a></li>
                            </ul>
                        </li>
                            <li><a href="{{route('insurance')}}"><i class="fa fa-credit-card"></i>General Insurance</a></li>
                            <li><a href="{{route('prepaidcard')}}"><i class="fa fa-credit-card"></i>Prepaid Card</a></li>

                        @if(Myhelper::hasRole('retailer'))
                        <li><a href="{{route('ration_card.user_index')}}"><i class="icon-cog"></i> Ration Card</a></li>
                        <li><a href="{{route('e_sharm.user_index')}}"><i class="icon-cog"></i>Esharm</a></li>
                                <li><a href="{{route('prepaidcard_load.user_index')}}"> <i class="icon-cog"></i> Prepaidcard Loads</a></li>
                                <li><a href="{{route('loan.user_index')}}"><i class="icon-cog"></i> Loan</a></li>
                                <li><a href="{{route('digital_signature.user_index')}}"><i class="icon-cog"></i>Digital Signature</a></li>
                                <li><a href="{{route('gst_reg.user_index')}}"><i class="icon-cog"></i>Gst Registration</a></li>
                                <li><a href="{{route('itr_reg.user_index')}}"><i class="icon-cog"></i>Itr Registration</a></li>
                                <li><a href="{{route('prepaidcard_kyc.user_index')}}"><i class="icon-cog"></i>Prepaidcard Kyc</a></li>
                                <li><a href="{{route('nsdl_pancard.user_index')}}"><i class="icon-cog"></i> Nsdl PanCard</a></li>
                        @endif
                            <li><a href="{{route('cms')}}"><i class="fa fa-credit-card"></i> CMS</a></li>
                            <li><a href="{{route('qrcode')}}"><i class="fa fa-credit-card"></i> QR Code</a></li>
                            <li><a href="{{route('virtualaccount')}}"><i class="fa fa-credit-card"></i> Virtual Account</a></li>
                    ...
                    @if (Myhelper::can(['view_whitelable','view_statehead', 'view_md', 'view_distributor', 'view_retailer', 'view_apiuser', 'view_other', 'view_kycpending', 'view_kycsubmitted', 'view_kycrejected']))
                    <li>
                        <a href="javascript:void(0)"><i class="icon-user"></i> <span>Member</span></a>
                        <ul>
                            @if (Myhelper::can(['view_whitelable']))
                            <li><a href="{{route('member', ['type' => 'whitelable'])}}">Admin</a></li>
                            @endif
                            @if (Myhelper::can(['view_statehead']))
                            <li><a href="{{route('member', ['type' => 'statehead'])}}">Sub Admin</a></li>
                            @endif
                            ...
                            <li><a href="{{route('member', ['type' => 'retailer'])}}">Agent</a></li>
                            @endif
                            @if (Myhelper::can(['view_apiuser']))
                            <li><a href="{{route('member', ['type' => 'web'])}}">Register User</a></li>
                            @endif
                            @if (Myhelper::can(['view_other']))
                            <li><a href="{{route('member', ['type' => 'other'])}}">Other User</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li>
                        ...
                        <ul>
                            @if (Myhelper::can('aepsid_statement'))
                                <li><a href="{{route('statement', ['type' => 'ekoaeps'])}}">Aeps </a></li>
                            @endif
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            @if (Myhelper::can('billpayment_statement'))
                                <li><a href="{{route('statement', ['type' => 'billpay'])}}">Billpay Statement</a></li>
                            @endif
                            ...
                            @if (Myhelper::can('payout_statement'))
                                <li><a href="{{route('statement', ['type' => 'payout'])}}">Payout Statement</a></li>
                            @endif
                            @if (Myhelper::can('xpressmoney_statement'))
                                <li><a href="{{route('statement', ['type' => 'xpressmoney'])}}">Xpress Money Transfer Statement</a></li>
                            @endif
                            ...
                            @endif
                            @if(Myhelper::hasNotRole('retailer'))
                             <li><a href="{{route('ration_card.index')}}">Ration Card</a></li>
                                <li><a href="{{route('e_sharm.index')}}">Esharm</a></li>
                                <li><a href="{{route('gst_reg.index')}}">Gst Registration</a></li>
                                <li><a href="{{route('itr_reg.index')}}">Itr Registration</a></li>
                                <li><a href="{{route('digital_signature.index')}}">Digital Signature</a></li>
                                <li><a href="{{route('loan.index')}}">Loan</a></li>
                                <li><a href="{{route('nsdl_pancard.index')}}">Nsdl PanCard Offline</a></li>
                                <li><a href="{{route('prepaidcard_kyc.index')}}">Prepaidcard Kyc</a></li>
                                <li><a href="{{route('prepaidcard_load.index')}}">Prepaidcard Loads</a></li>
                            @endif
                        </ul>
                    </li>
                      @if (Myhelper::hasNotRole('retailer'))
                       {{--  <li><a href="{{route('ration_card.index')}}"><i class="icon-cog"></i> Ration Card</a></li>
                        <li><a href="{{route('e_sharm.index')}}"><i class="icon-cog"></i>Esharm</a></li>
                                <li><a href="{{route('prepaidcard_load.index')}}"> <i class="icon-cog"></i> Prepaidcard Loads</a></li>
                                <li><a href="{{route('loan.index')}}"><i class="icon-cog"></i> Loan</a></li>
                                <li><a href="{{route('digital_signature.index')}}"><i class="icon-cog"></i>Digital Signature</a></li>
                                <li><a href="{{route('gst_reg.index')}}"><i class="icon-cog"></i>Gst Registration</a></li>
                                <li><a href="{{route('itr_reg.index')}}"><i class="icon-cog"></i>Itr Registration</a></li>
                                <li><a href="{{route('prepaidcard_kyc.index')}}"><i class="icon-cog"></i>Prepaidcard Kyc</a></li>
                                <li><a href="{{route('nsdl_pancard.index')}}"><i class="icon-cog"></i> Nsdl PanCard</a></li> --}}
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('setup', ['type' => 'links'])}}">Quick Links</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
