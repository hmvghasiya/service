@extends('layouts.app')
@section('title', 'NSDL PanCard Form Registration')
@section('pagetitle', 'NSDL PanCard Form Registration')
@section('content')
<div class="content">
    <form class="FromSubmit" action="{{ route('nsdl_pancard.store') }}" id="rationform" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="application_type" class="form-control select application_type" id="application_type" >
                                    ...
                                    @foreach (getApplicationTypeDropdown() as $key=>$value)
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('change', '#application_type', function(event) {
            ...
            $.ajax({
                url: '{{route('nsdl_pancard.nsdl_data')}}',
                type: 'Get',
